...
export const globalStyles = StyleSheet.create({
  ...
  titlePlace: { fontSize: 24, fontWeight: "bold", marginBottom: 8 },
  ratingPlace: { fontSize: 18, marginBottom: 8 },
  addressPlace: { fontSize: 16, marginBottom: 8 },
  detailsPlace: { fontSize: 14, color: "#555", marginBottom: 8 },
  loadingContainerPlace: {
    flex: 1,
    justifyContent: "center",
    alignItems: "center",
  },
  headerContainerPlace: {
    flex: 0.06,
    width: "100%",
  ...
  reviewContainerPlace: {
    backgroundColor: "#f2f2f2",
    padding: 10,
    marginBottom: 10,
    borderRadius: 8,
  },
  reviewAuthorPlace: { fontWeight: "bold", fontSize: 16 },
  reviewRatingPlace: { fontSize: 14, color: "#888" },
  reviewTextPlace: { fontSize: 14, color: "#555", marginTop: 5 },
  noReviewsTextPlace: {
    fontSize: 14,
    color: "#555",
    fontStyle: "italic",
  ...
  loadMoreButtonContainerPlace: { alignItems: "center", marginVertical: 10 },
  loadMoreButtonPlace: {
    backgroundColor: "pink",
    padding: 10,
    borderRadius: 15,
